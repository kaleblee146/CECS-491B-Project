...
from .views import UserList, register_user, login_user, home_view, welcome_view, registration_view, confirm_password_reset, request_password_reset, social_login
